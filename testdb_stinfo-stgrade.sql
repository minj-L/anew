...
insert into st_info values (202201, 'LeeGiiDong', 'Game');
insert into st_info values (202202, 'KimGiiDong', 'Computer');
insert into st_info values (202203, 'HongGiiDong', 'Game');
select * from st_info;
